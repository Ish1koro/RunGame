...
public class MySqlAccess : MonoBehaviour
{
    ...
    public string CreateURL(string Url, string user, string password, string database, string sql)
    {
        string param = Url + "?user=" + user + "&password=" + password + "&database=" + database + "&sql=" + sql;
        return param;
    }
    /// <summary>
